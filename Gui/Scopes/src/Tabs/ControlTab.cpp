...
ControlTab::ControlTab(QWidget *parent) noexcept
	...
	std::ignore = connect(this, SIGNAL(editModeChanged(bool)), page1, SLOT(editModeChange(bool)));
	QTabWidget::addTab(page1, "tab1");

	auto page2 = new TabPage;
	std::ignore = connect(this, SIGNAL(editModeChanged(bool)), page2, SLOT(editModeChange(bool)));
